package com.praveenkesarwani.model.parking.strategy;
...
public interface ParkingStrategy {
  ...
  /**
   * Add a new slot to parking strategy. After adding, this new slot will become
   * available for
   * future parkings.
   *
  ...
  /**
   * Removes a slot from the parking strategy. After removing, this slot will not
   * be used for future
   * parkings.
   *
