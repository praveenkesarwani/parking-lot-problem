...
public class Command {
  ...
  /**
   * Constructor. It takes the input line and parses the command name and param
   * out of it. If the
   * command or its given params are not valid, then
   * {@link InvalidCommandException} is thrown.
   *
