package com.praveenkesarwani;

/**
 * Printer to help in printing the output back to the user. Output medium can be
 * changed here
 * anytime without affecting any of the other code. Currently, System.out is
 * used. Tomorrow if file
...
public class OutputPrinter {
  ...
  public void statusHeader() {
    printWithNewLine("Slot No.    Registration No    Driver's Age");
  }
